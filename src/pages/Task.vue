        ...
        <div class="md-screen">
          <div class="q-ma-md div-table">
            ...
            <div class="row">
              ...
              <div class="col text-left text-bold">Bağlı Şirketler Görünsün Mü?</div>
              <div class="col text-left text-bold">Kayıt Tarihi</div>
            ...
            <div class="row div-row" v-for="(i, index) in data" :key="i" :class="GetRowClass(index)">
              ...
              <div class=" col text-left">{{ i.createDate }}</div>
              <div class=" col text-left">
...
import data from 'src/data/task.json'
