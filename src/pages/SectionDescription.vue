<template>
  <page-container title="Bölüm Tanımlama">
    <template #icon>
    ...
    <q-page-container>
      ...
      <!--  <div class="q-pa-md">
        ...
        <q-table :grid="$q.screen.xs" flat bordered title="Bölüm Tanım Listesi" ref="tableRef" :rows="data"
  ...
  <form-modal-dialog v-model="addUpdateDialog" title="Bölüm" icon="fa-solid fa-briefcase" negative="Kapat"
    ...
    <div class="input-group">
      <q-input class="txt" v-model="dataItem.sectionName" filled label="Bölüm Adı" lazy-rules
...
import data from 'src/data/sectionDescription.json'
