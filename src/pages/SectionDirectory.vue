<template>
  <page-container title="Bölüm Rehberi">
    <template #icon>
        ...
        <div class="md-screen">
          <div class="q-ma-md div-table">
            ...
            <div class="row">
              ...
              <div class="col text-left text-bold">Bölüm Adı</div>
            ...
            <div class="row div-row" v-for="(i, index) in data" :key="i" :class="GetRowClass(index)">
              ...
              <div class=" col text-left"> {{ i.sectionName }} </div>
              <div class=" col text-left">
  ...
  -->
  <form-modal-dialog v-model="addUpdateDialog" title="Bölüm" icon="fa-solid fa-briefcase" negative="Kapat"
    @positive="updateCommit()">

    <div class="input-group">
      <q-select class="select" v-model="dataItem.sectionName" filled :virtual-scroll-horizontal="false"
        :options="['Seçiniz', 'İlkokul', 'Ortaokul', 'Lise']" label="Bölüm Adı" lazy-rules
  ...
  <form-modal-dialog v-model="deleteDialog" title="Sözleşme Silme Onayı" icon="fa-solid fa-trash" @positive="del()"
    ...
    <span class="q-ml-sm">
      <p>{{ dataItem.sectionName }} bölümün silinmesini onaylıyor musunuz ?</p>
    </span>
  </form-modal-dialog>
  <!-- Delete modal end -->
</template>
...
import data from 'src/data/sectionDirectory.json'
